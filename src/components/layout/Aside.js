...
return`<aside class="filter">
    <div class="hero-aside">
        <ul id="hero-aside-items" class="hero-aside-items">
            <li data-id="home" class="active2">
            ...
            <li data-id="meus-filmes">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M22 12c0-5.51-4.49-10-10-10S2 6.49 2 12s4.49 10 10 10h10v-2h-4.03c2.44-1.83 4.03-4.73 4.03-8M4 12c0-4.41 3.59-8 8-8s8 3.59 8 8-3.59 8-8 8-8-3.59-8-8"></path>
                    <path d="M12 6a2 2 0 1 0 0 4 2 2 0 1 0 0-4m0 8a2 2 0 1 0 0 4 2 2 0 1 0 0-4m4-4a2 2 0 1 0 0 4 2 2 0 1 0 0-4m-8 0a2 2 0 1 0 0 4 2 2 0 1 0 0-4"></path>
                </svg> 
                Meus filmes
            </li>
            <li data-id="favoritos">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            <li data-id="sair">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M9.71 17.29 5.41 13H15v-2H5.41l4.3-4.29-1.42-1.42L1.59 12l6.7 6.71z"></path>
                    <path d="M13 19v2c4.96 0 9-4.04 9-9s-4.04-9-9-9v2c3.86 0 7 3.14 7 7s-3.14 7-7 7"></path>
                </svg> 
                Sair
            </li>
        </ul>
